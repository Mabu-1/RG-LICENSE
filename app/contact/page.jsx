        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: 13, color: "#64748b" }}>
                +880 1971 914828 — fastest response
              </div>
            </div>
            <div style={{ marginLeft: "auto", fontSize: 20, color: "#BFDBFE" }}>
              →
            </div>
          </a>

          {/* Email */}
          <a href="mailto:support@shopreview.app" style={cardStyle}>
            <div style={iconBox("#2563EB")}>
              <svg
                width="22"
                height="22"
                viewBox="0 0 24 24"
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: 13, color: "#64748b" }}>
                Schedule a setup or support meeting
              </div>
            </div>
            <div style={{ marginLeft: "auto", fontSize: 20, color: "#BFDBFE" }}>
              →
