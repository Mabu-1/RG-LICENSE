  ...
  return (
    <>
      <style>{`
        ...
        .ts-wrap { width: 100%; max-width: 820px; background: #fff; border-radius: 16px; box-shadow: 0 20px 60px rgba(37,99,235,0.1); overflow: hidden; border: 1px solid #BFDBFE; }
        ...
        .ts-dot { width: 8px; height: 8px; border-radius: 50%; background: #2563EB; flex-shrink: 0; }
        ...
        .ts-item:hover { background: #EFF6FF; }
        .ts-item-label { font-size: 11px; color: #334155; font-weight: 500; display: flex; align-items: center; gap: 5px; white-space: nowrap; }
        .ts-item-val { font-size: 10px; color: #2563EB; font-weight: 700; background: #EFF6FF; padding: 2px 6px; border-radius: 4px; white-space: nowrap; flex-shrink: 0; }
