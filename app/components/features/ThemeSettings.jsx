...
export default function ThemeSettings() {
  ...
  const visible = isMobile && !expanded ? settings.slice(0, MOBILE_SHOW) : settings
...
.ts-grid { width: 100%; display: grid; gap: 0; border: 2px solid #BFDBFE; border-radius: 18px; overflow: hidden; box-shadow: 0 4px 32px rgba(37,99,235,0.08); outline: 5px solid #EFF6FF; outline-offset: -7px; }
...
.ts-fade { position: absolute; bottom: 44px; left: 0; right: 0; height: 70px; background: linear-gradient(to bottom, transparent, rgba(239,246,255,0.97)); border-radius: 0 0 14px 14px; pointer-events: none; }
.ts-toggle { margin-top: 14px; display: inline-flex; align-items: center; gap: 8px; background: #fff; border: 1.5px solid #BFDBFE; border-radius: 100px; padding: 10px 22px; font-size: 13px; font-weight: 700; color: #2563EB; cursor: pointer; transition: all 0.2s; box-shadow: 0 2px 12px rgba(37,99,235,0.08); }
...
@media (max-width: 640px) {
  ...
  .ts-item { border-right: none; border-bottom: 1px solid #EFF6FF; }
  .ts-item:last-child { border-bottom: none; }
        ...
        <div className="rgl-container">
          <div className="ts-center">
            ...
            <div className="ts-wrap">
              ...
              {isMobile && !expanded && <div className="ts-fade" />}
            </div>
