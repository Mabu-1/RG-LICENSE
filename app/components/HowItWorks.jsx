const steps = [
  ...
  {
    n: "2",
    t: "We Install Everything",
    d: "Connect your Shopify store in around 30 minutes.",
  },
  {
    n: "3",
    t: "Start Collecting Trust",
    d: "Your premium review widgets go live immediately.",
  },
];
...
export default function HowItWorks() {
  return (
    <>
      <style>{`
        .rgl-how { padding: 100px 0; background: linear-gradient(135deg, #ffffff 0%, #EFF6FF 60%, #DBEAFE 100%); }
        .rgl-how-header { text-align: center; margin-bottom: 64px; }
        .rgl-how .rgl-section-eyebrow { color: #2563EB; }
        ...
        .rgl-steps::before { content: ''; position: absolute; top: 27px; left: calc(16.66% + 24px); right: calc(16.66% + 24px); height: 1px; background: repeating-linear-gradient(90deg,#2563EB 0,#2563EB 6px,transparent 6px,transparent 12px); }
        .rgl-step { text-align: center; position: relative; z-index: 1; }
        .rgl-step-num { width: 54px; height: 54px; background: #2563EB; color: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-family: 'Fraunces', serif; font-size: 22px; font-weight: 900; margin: 0 auto 20px; box-shadow: 0 8px 24px rgba(37,99,235,0.3); }
