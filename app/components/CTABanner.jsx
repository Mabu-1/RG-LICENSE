export default function CTABanner() {
  return (
    <>
      <style>{`
        .rgl-cta-banner { background: #2563EB; padding: 80px 0; }
        ...
        .rgl-btn-white { display: inline-flex; align-items: center; gap: 8px; padding: 16px 36px; background: #fff; color: #2563EB; border-radius: 100px; font-weight: 700; font-size: 16px; transition: all 0.25s; border: 2px solid #fff; text-decoration: none; }
      ...
      <section className="rgl-cta-banner">
        <div className="rgl-container">
          <div className="rgl-cta-inner">
            ...
            <a href="#pricing" className="rgl-btn-white">
              Get Your License →
            </a>
          </div>
        </div>
