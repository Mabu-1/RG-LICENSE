...
function BookContent() {
  ...
  return (
    <>
      <style>{`
        .bk-wrap { min-height: 100vh; background: linear-gradient(135deg,#fff 0%,#EFF6FF 60%,#DBEAFE 100%); display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 40px 24px; text-align: center; }
        .bk-header { position: absolute; top: 0; left: 0; right: 0; display: flex; align-items: center; padding: 20px 32px; }
        ...
        .bk-h1 { font-family: serif; font-size: clamp(26px,5vw,42px); font-weight: 900; color: #0F172A; letter-spacing: -1.5px; margin-bottom: 12px; line-height: 1.1; }
        .bk-sub { font-size: 15px; color: #64748b; margin-bottom: 40px; line-height: 1.7; max-width: 480px; }

        /* Price box */
        .bk-price-box { background: white; border-radius: 20px; padding: 36px 40px; border: 1px solid #BFDBFE; box-shadow: 0 8px 40px rgba(37,99,235,0.08); max-width: 420px; width: 100%; margin: 0 auto 24px; }
        ...
        .bk-trial-dot { width: 6px; height: 6px; background: #22C55E; border-radius: 50%; }
        .bk-trial-label { font-size: 11px; font-weight: 700; color: #15803D; }
        .bk-price-row { display: flex; align-items: baseline; justify-content: center; gap: 4px; margin-bottom: 6px; }
        ...
        .bk-then { font-size: 14px; color: #64748b; margin-bottom: 28px; }
        .bk-then strong { color: #0F172A; font-size: 16px; }
        .bk-cta { display: flex; align-items: center; justify-content: center; gap: 10px; padding: 17px 0; background: #2563EB; color: white; border-radius: 100px; font-size: 16px; font-weight: 700; text-decoration: none; transition: all 0.25s; box-shadow: 0 8px 28px rgba(37,99,235,0.3); width: 100%; }
        .bk-cta:hover { background: #1D4ED8; transform: translateY(-2px); }
        .bk-note { font-size: 12px; color: #94a3b8; margin-top: 12px; }

        @media (max-width: 480px) {
          .bk-wrap { padding: 80px 20px 40px; justify-content: flex-start; }
          .bk-amount { font-size: 72px; }
          .bk-price-box { padding: 28px 24px; }
        }
      `}</style>
      ...
      <div className="bk-wrap">
        ...
        <p className="bk-sub">
          Your order is saved. Pick a time for your setup call and we will get
          your review gallery live within 24 hours.
        </p>
