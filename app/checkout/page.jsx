...
function CheckoutContent() {
  ...
  function validate() {
    ...
    else if (!/^[\d\s\+\-\(\)]+$/.test(form.whatsapp.trim()))
      e.whatsapp = "Numbers only please";

    const domainRegex = /^[a-zA-Z0-9][a-zA-Z0-9\-\.]+\.[a-zA-Z]{2,}$/;
    domains.forEach((d, i) => {
      if (!d.trim()) {
        e[`domain${i}`] =
          i === 0 ? "Required" : "Enter the domain or remove this field";
      } else if (
        !domainRegex.test(
          d
            .trim()
      ...
      <div className="co-wrap">
        <div className="co-inner">
          ...
          <div className="co-card">
            ...
            <div>
              ...
              <textarea
                ...
                style={{ ...inp(false), height: 80, resize: "vertical" }}
              />
            </div>
          </div>
          ...
          <div className="co-card">
            ...
            >
              First 3 domains are free. Each additional domain is +$10.
            </p>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      delete newErrors[`domain${i}`];
                      setErrors(newErrors);
                    }}
                    placeholder="yourstore.myshopify.com"
                    style={inp(errors[`domain${i}`])}
                  />
                  {errors[`domain${i}`] && (
